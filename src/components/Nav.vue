<template>
  <nav class="fixed w-full bg-gradient-to-b from-cultured via-cultured to-transparent pb-12">
    <div class="container flex items-center justify-center p-5 mx-auto text-gray-800 capitalize dark:text-gray-300">
      ...
      <a href="#" class="border-b-2 border-transparent hover:text-gray-900 dark:hover:text-gray-200 hover:border-celadonBlue mx-1.5 sm:mx-6">Contact</a>
    </div>
  </nav>
</template>
